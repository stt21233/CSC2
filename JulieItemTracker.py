...
# Create buttons
Button(main_window, text="Append details", font=("Helvetica bold", 8)).grid(row=7,column=2)
Button(main_window, text="Print details", font=("Helvetica bold", 8)).grid(row=8, column=2)
Button(main_window, text="Delete",font=("Helvetica bold", 8)).grid(row=10, column=2)
Button(main_window, text="Quit program", font=("Helvetica bold", 8)).grid(row=0, column=40)
