...
Label(main_window, text="Customer full name", font=("Helvetica bold", 14)).grid(row=4, column= 1)
entry_name = Entry(main_window)
entry_name.grid(row=2, column= 1)
Label(main_window, text="Receipt number", font=("Helvetica bold", 14)).grid(row=4, column=2)
entry_receipt = Entry(main_window)
entry_receipt.grid(row=4, column=2)
Label(main_window, text="Item hired", font=("Helvetica bold", 14)).grid(row=4, column=4)
entry_hireditem = Entry(main_window)
entry_hireditem.grid(row=5, column=4)
Label(main_window, text="Number of hired items",font=("Helvetica bold", 14)).grid(row=4, column=5)
entry_number_of_hired_item = Entry(main_window)
entry_hireditem.grid(row=6, column=6)
Label(main_window, text="Delete row #", font=("Helvetica bold", 14)).grid(row=4, column=6)
