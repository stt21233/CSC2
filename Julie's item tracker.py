...
# print camp detail (when press print all details will show)
def print_camp_details():
    # these are the global variables that are used
    global entry_name, entry_receiptnumber, entry_hireditem, entry_totalhired
    name_count = 0
    # Create the column headings
    Label(main_window, font=("Helvetica 10 bold"),
          text="full name").grid(column=0, row=7)
    Label(main_window, font=("Helvetica 10 bold"),
          text="receipt number").grid(column=1, row=7)
    Label(main_window, font=("Helvetica 10 bold"),
          text="item hired").grid(column=2, row=7)
    Label(main_window, font=("Helvetica 10 bold"),
          text="number of hired item").grid(column=3, row=7)
    Label(main_window, font=("Helvetica 10 bold") )
...
# create button - append details
def append_name():
    # these are the global variables that are used
    global camp_details, entry_name, entry_location, entry_campers, entry_weather, total_entries
...
def setup_buttons():
    ...
    Label(main_window, text="boss") .grid(column=0, row=0, sticky=E)
